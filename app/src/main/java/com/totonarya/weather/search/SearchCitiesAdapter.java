...
import com.totonarya.weather.home.HomeContract;

import java.util.List;

public class SearchCitiesAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private Context context;
    private List<SearchCities> citiesList;

    public SearchCitiesAdapter(Context context, List<SearchCities> citiesList) {
...
//Bind Data
        ...
        myItemViewHolder.searchLayout.setAnimation(AnimationUtils.loadAnimation(context, R.anim.searchitem_anim));
    ...
    public void filterList(List<SearchCities> searchCities) {
        citiesList = searchCities;
